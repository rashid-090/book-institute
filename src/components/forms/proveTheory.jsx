    ...
    switch (step) {
      ...
      case 2:
        return (
          <>
            <h2 className="text-xl font-semibold text-white mb-6 text-center">
              Step 2: Educational & Professional Details
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Education Level */}
              <div className="md:col-span-2">
      ...
      case 4:
        return (
          <>
            <h2 className="text-xl font-semibold text-white mb-6 text-center">
              Step 4: Upload Refutation Files
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* File Upload */}
              <div className="md:col-span-2">
                <label className="block text-white">
                  Upload your arguments, diagrams, or supporting documents (PDF, DOCX, Image Formats)
                </label>
                <input
                  type="file"
              ...
              {/* Additional Comments */}
              <div className="md:col-span-2">
                <label className="block text-white">Do you have any additional notes?</label>
                <textarea
        ...
        return (
          <>
            ...
            <div className="text-white text-center">
              ...
              <p>Your submission has been received and will be reviewed by our panel.</p>
            </div>
          </>
        );
  ...
  return (
    <section className="w-[100%] md:w-[60%] mx-auto bg-white/20 text-black backdrop-blur-md rounded-lg p-6 shadow-lg">
      ...
      <div className="flex justify-between items-center mb-6 relative">
        {["Personal Details", "Education & Professional", "Book Check", "Upload Files", "Confirmation"].map(
          (label, index) => (
      ...
      <div className="flex justify-between mt-6">
        ...
        {step < 5 ? (
          <button
            onClick={step === 3 ? validateSerialNumber : nextStep}
            className="bg-mainclr text-white p-2 rounded-md hover:bg-mainhvr transition"
          >
            Next
          </button>
...
export default RefuteTheoryForm;