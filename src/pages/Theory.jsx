...
const ProveTheory = () => {
  ...
  return (
    ...
    <section className="w-11/12 xl:w-10/12 mx-auto py-20">
          ...
          <div className="w-full grid place-items-center"><button onClick={()=>handelButton()} className="bg-mainclr px-10 h-12 rounded-full capitalize">Prove Theory</button></div>
          {/* form */}
